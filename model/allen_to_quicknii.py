...
def allen2quicknii(series_id,get_orig,target_dir=""):
    ...
    # QuickNII: [456,528,320] RAS, Allen: PIR
    ...
    for section in sec_im:
        ...
        o = (o_r,528-o_p,320-o_i)
        u = (u_r-o_r,o_p-u_p,o_i-u_i)
        v = (v_r-o_r,o_p-v_p,o_i-v_i)
        xml.write("  <slice filename='{}_s{:04}.jpg' nr='{}' width='{}' height='{}' anchoring='".format(sec_id,sec_num,sec_num,sec_width,sec_height))
...
""" 
Thank you to Gergely Csúcs and Christopher Coello of the Nesys Lab at 
the University of Oslo for this script
"""